...
public class RabbitMqApiController {
    ...
    public Result overview(){
        try {
            return Result.ok().success(true).data("data",service.overview());
        } catch (IOException e) {
    ...
    public Result connections() {
        try {
            return Result.ok().success(true).data("data",service.connections());
        } catch (IOException e) {
            throw new BusinessException(ResultCode.RABBITMQ_API_READ_FAILURE.getCode(),ResultCode.RABBITMQ_API_READ_FAILURE.getMessage());
        } catch (AuthenticationException e) {
            throw new BusinessException(ResultCode.RABBITMQ_API_AUTH_FAILURE.getCode(),ResultCode.RABBITMQ_API_AUTH_FAILURE.getMessage());
    ...
    public Result channels() {
        try {
            return Result.ok().success(true).data("data",service.channels());
        } catch (IOException e) {
            throw new BusinessException(ResultCode.RABBITMQ_API_READ_FAILURE.getCode(),ResultCode.RABBITMQ_API_READ_FAILURE.getMessage());
        } catch (AuthenticationException e) {
            throw new BusinessException(ResultCode.RABBITMQ_API_AUTH_FAILURE.getCode(),ResultCode.RABBITMQ_API_AUTH_FAILURE.getMessage());
    ...
    public Result exchanges() {
        try {
            return Result.ok().success(true).data("data",service.exchanges());
        } catch (IOException e) {
            throw new BusinessException(ResultCode.RABBITMQ_API_READ_FAILURE.getCode(),ResultCode.RABBITMQ_API_READ_FAILURE.getMessage());
        } catch (AuthenticationException e) {
            throw new BusinessException(ResultCode.RABBITMQ_API_AUTH_FAILURE.getCode(),ResultCode.RABBITMQ_API_AUTH_FAILURE.getMessage());
    ...
    public Result queues() {
        try {
            return Result.ok().success(true).data("data",service.queues());
        } catch (IOException e) {
            throw new BusinessException(ResultCode.RABBITMQ_API_READ_FAILURE.getCode(),ResultCode.RABBITMQ_API_READ_FAILURE.getMessage());
        } catch (AuthenticationException e) {
            throw new BusinessException(ResultCode.RABBITMQ_API_AUTH_FAILURE.getCode(),ResultCode.RABBITMQ_API_AUTH_FAILURE.getMessage());
